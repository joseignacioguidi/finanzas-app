...
import { LayoutDashboard, ArrowLeftRight, CalendarDays, Tag, BarChart2, Target, PiggyBank, User, Settings, LogOut } from 'lucide-react'
...
const sections = [
  {
    ...
    items: [
      ...
      { href: '/savings', label: 'Ahorros', icon: PiggyBank, activeSegment: 'savings' },
