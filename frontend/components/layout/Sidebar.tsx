...
import { LayoutDashboard, ArrowLeftRight, BarChart2, User, Settings, LogOut } from 'lucide-react'
...
const sections = [
  {
    ...
    items: [
      ...
      { href: '/transactions', label: 'Reportes', icon: BarChart2, activeSegment: '__none__' },
    ],
  },
  {
    label: 'Cuenta',
